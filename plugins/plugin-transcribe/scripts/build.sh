#!/usr/bin/env bash
#
# Build @deepcraft/plugin-transcribe into ./dist/*.tgz — a single-file pipeline.
#
...
NOCOBASE_VERSION="${NOCOBASE_VERSION:-2.2.6}"
...
#                     plugins in nocobase 2.2.x pin react@18.2.0, antd@5.24.2).
