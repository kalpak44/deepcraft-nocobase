 ...
 * from spoofing the result of a Google connection, and a security control that
 * cannot be asserted on is one nobody can prove still works.
 *
...
export function isTrustedOAuthMessage(
  ...
  return d.source === 'nocobase-google-oauth';
}