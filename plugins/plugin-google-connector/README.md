# @deepcraft/plugin-google-connector
...
ln -s ../.. plugins/@deepcraft/plugin-google-connector
nb plugin enable @deepcraft/plugin-google-connector
```
...
```bash
just build-plugin plugin-google-connector
